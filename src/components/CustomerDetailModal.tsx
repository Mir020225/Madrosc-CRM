                    ...
                    <div className="flex space-x-1 p-1 overflow-x-auto">
                        {TABS.map(tab => (
                            <button
                                ...
                                className={`py-2 px-4 font-medium text-sm rounded-md transition-colors duration-200 flex-shrink-0 ${activeTab === tab.id ? 'bg-black/5 dark:bg-white/10 text-[var(--text-primary-light)] dark:text-[var(--text-primary-dark)]' : 'text-[var(--text-secondary-light)] dark:text-[var(--text-secondary-dark)] hover:bg-black/5 dark:hover:bg-white/5'}`}
                            >
